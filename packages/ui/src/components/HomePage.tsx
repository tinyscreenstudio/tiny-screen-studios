...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={device.name} className="group card p-6 text-center animate-scale-in hover:shadow-xl hover:-translate-y-2 transition-all duration-300" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className={`w-12 h-12 bg-gradient-to-br ${device.color === 'indigo' ? 'from-indigo-500 to-indigo-600' :
                ...
                <h4 className={`font-semibold text-gray-900 mb-2 ${device.color === 'indigo' ? 'group-hover:text-indigo-600' :
      ...
      {/* OLED Studio Section */}
      <section id="oled-studio-section" className="py-16 lg:py-24 bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full blur-3xl opacity-20 animate-float"></div>
          <div className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full blur-3xl opacity-20 animate-float-delayed"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full blur-3xl opacity-10"></div>
        </div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in">
              <div className="inline-flex items-center gap-2 px-4 py-2 backdrop-blur-sm rounded-full text-sm font-medium mb-8 shadow-lg" style={{
              ...
              <p className="text-xl lg:text-2xl mb-12 leading-relaxed font-light text-gray-300 max-w-3xl mx-auto">
                Jump into the full OLED Studio experience with advanced tools, real-time preview, and professional export options.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                ...
                >
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: 'rgba(255, 255, 255, 1)' }}></div>
                  <EyeIcon className="w-5 h-5 relative z-10" />
                ...
                <button className="group px-8 py-4 rounded-2xl font-semibold text-lg backdrop-blur-sm transition-all duration-300 shadow-sm hover:shadow-md" style={{
                  ...
                  <span className="group-hover:opacity-80 transition-opacity duration-300">Learn More</span>
                </button>
              </div>

              {/* Quick feature highlights */}
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-16 text-sm">
                <div className="flex items-center gap-2 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: `1px solid rgba(16, 185, 129, 0.3)` }}>
                  <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: 'var(--color-success)' }}></div>
                  <span className="text-gray-300">Drag & Drop Upload</span>
                </div>
                <div className="flex items-center gap-2 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: `1px solid rgba(59, 130, 246, 0.3)` }}>
                  <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: 'var(--color-info)' }}></div>
                  <span className="text-gray-300">Live Preview</span>
                </div>
                <div className="flex items-center gap-2 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: `1px solid rgba(139, 92, 246, 0.3)` }}>
                  <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: '#8b5cf6' }}></div>
                  <span className="text-gray-300">Export Ready Code</span>
                </div>
              </div>
            </div>
          </div>
